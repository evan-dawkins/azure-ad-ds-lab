...
Provisioned CLIENT01, configured it to use DC01 for DNS, and joined it to the domain
Verified end-to-end authentication: logged in as a domain user on CLIENT01 and confirmed correct group membership via whoami /groups
Completed additional administrative tasks: delegated password-reset rights to the Helpdesk group, configured a domain-wide password policy, and moved the client computer object into its correct OU
Troubleshooting Log
